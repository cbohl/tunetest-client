                ...
                return(
                  <li className="rows-span-1" key={i}>
                      <div className="mx-auto block lg:h-5/6 lg:w-1/3 sm:h-5/6 sm:w-1/4 h-2/3 w-1/2 rounded-md overflow-hidden group">
                        ...
                        {/* </div> */}
                        <img src= {"http://quiet-moon-2330.fly.dev/static/images/" + artist.lastName + "2.webp"} className="object-cover scale-100 hover:scale-125 ease-in duration-500 z-10"></img>
                      </div>
                  </li>
                )
              })}
                      ...
                      {/* <div className="group">
                        ...
                        <img class="invisible group-hover:visible" src= {"http://quiet-moon-2330.fly.dev/static/images/" + "Beatles" + "2.webp"} className="scale-100 hover:scale-125 ease-in duration-500 z-10"></img>
