                ...
                <div className="flex min-h-screen justify-center">
                    <div className="grid max-w-3xl min-w-[60%] max-h-screen grid-rows-3 text-center">
                        <div className="rows-span-1">
                            ...
                            <div className="my-5">
                                <a href={'/'} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Go back to home page</a>
                            </div>
                        </div>
                        { !scoreSubmitted ?
                            <div className="rows-span-1">
                            ...
                            <div className="rows-span-1"> 
                                <div className="mx-auto block lg:h-5/6 lg:w-1/3 sm:h-5/6 sm:w-1/4 h-2/3 w-1/2 rounded-md overflow-hidden group">
                                    <img src= {process.env.REACT_APP_API_URL + "/static/images/" + artist.lastName + "2.webp"} className="object-cover scale-100 z-10"></img>
                                </div>
                            </div>
                        }
                        <div>
